...
import java.util.*;
   ...
   public class ProblemI {
        ...
        public ProblemI(String key, String plainText)
        {
     ...
     class GFG {
        public static void main(String[] args)
        {
            ...
            String key1 = "ThisIsATest";
            String plainText1 = "AQuickBrownFox";

            System.out.println("Key: " + key1);
            System.out.println("PlainText: " + plainText1);

            ProblemI pfc1 = new ProblemI(key1, plainText1);
            ...
            ProblemI pfc2 = new ProblemI(key2, plainText2);
